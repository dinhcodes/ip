...
public class DateTimeParser {
     ...
     */
    private static final List<String> DATE_ONLY_PATTERNS = Arrays.asList("d/M/yyyy", "dd/MM/yyyy", "yyyy-MM-dd");
    ...
    /**
     * Formats a local date time to a user-friendly {@code String}.
     *
